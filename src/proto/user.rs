...
pub struct User {
    ...
    pub access_token_expires_at: ::core::option::Option<::prost_types::Timestamp>,
    /// optional in Rust
    #[prost(message, optional, tag = "9")]
    pub refresh_token_expires_at: ::core::option::Option<::prost_types::Timestamp>,
}
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn remove_user(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/RemoveUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "RemoveUser"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/user.UserService/RemoveUser" => {
                    ...
                    struct RemoveUserSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    ...
                    for RemoveUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UserService>::remove_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
